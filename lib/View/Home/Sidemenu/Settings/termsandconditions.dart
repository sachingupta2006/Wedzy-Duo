...
class TermsAndConditionsDuo extends StatefulWidget {
  const TermsAndConditionsDuo({super.key});

  @override
  State<TermsAndConditionsDuo> createState() => _TermsAndConditionsDuoState();
}

class _TermsAndConditionsDuoState extends State<TermsAndConditionsDuo> {
      ...
      body: SafeArea(
        ...
        children: [
          ...
          Align(
            ...
            child: SvgPicture.asset("assets/svg/termsandconditions.svg"),
          ),
          sizedBoxHeight(27.h),
          Padding(
